 ...
 <?php
    ...
    $query = mysqli_query($db, "SELECT * FROM tbl_ipk");
    ?>
             ...
             <div class="row">
                 <div class="col-sm-12">
                     <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                         <thead>
                             <tr role="row">
                                 <th style="width: 118.2px;">Tahun Lulus </th>
                                 <th style="width: 82.2px;">Jumlah Lulusan </th>
                                 <th style="width: 63.2px;">Min.</th>
                                 <th style="width: 63.2px;">Rata-rata</th>
                                 <th style="width: 63.2px;">Maks</th>
                                ...
                                ?>
                                 ...
                                 <tr role="row" class="odd" style="font-size: 14px;">
                                     ...
                                     <td>
                                         ...
                                         <p class="text-break"><?php echo $data["ipk_min"]; ?></p>

                                     </td>
                                     <td>

                                         <p class="text-break"><?php echo $data["ipk_max"]; ?></p>

                                     </td>
                                     <td>

                                         <p class="text-break"><?php echo $data["avg_ipk"]; ?></p>
