     ...
     <div class="card-body">
         <div class="row">
             <div class="col-sm-10 mt-2">
                 <h2>Data Tabel Dosen Pembimbing Utama Tugas Akhir</h2>
             </div>
 ...
 <?php
    ...
    $query = mysqli_query($db, "SELECT * FROM tbl_dospem_ta");
                     ...
                     <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                         <thead>
                             <tr role="row">
                                 ...
                                 <th style="width: 63.2px;">TS-2 </th>
                                 <th style="width: 63.2px;">TS-1 </th>
                                 ...
                                 <th style="width: 63.2px;"> TS </th>
                                 <th style="width: 63.2px;">Rata-rata </th>
                                 <th style="width: 63.2px;">Rata-rata jumlah bimbingan </th>
