     ...
     <div class="card-body">
         <div class="row">
             <div class="col-sm-10 mt-2">
                 <h2>Data Tabel Kepuasan Pengguna Lulusan
                 </h2>
             </div>
 ...
 <?php
    ...
    $query = mysqli_query($db, "SELECT * FROM tbl_kepuasan_pengguna_lulusan");
    ?>
             ...
             <div class="row">
                 <div class="col-sm-12">
                     <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                         <thead>
                             <tr role="row ">
                                 <th rowspan="2" style="width: 118.2px;">Jenis Kemampuan </th>
                                 <th class="text-center" colspan="4" style=" width: 63.2px;">Tingkat Kepuasan Pengguna
                                     (%) </th>
                                 <th rowspan="2" style=" width: 82.2px;">Rencana Tindak Lanjut oleh UPPS </th>
                                 <th rowspan="2" style="width: 40.2px;">Edit </th>
                                 <th rowspan="2" style="width: 40.2px;">Delete </th>
                             </tr>
                             <tr>
                                 <th class="text-center" style="width: 63.2px;">Sangat Baik</th>
                                 <th class="text-center" style="width: 63.2px;">Baik</th>
                                 <th class="text-center" style="width: 63.2px;">Cukup</th>
                                 <th class="text-center" style="width: 63.2px;">Kurang</th>
                             </tr>
                         </thead>
                         <tbody>
                                ...
                                ?>
                                 ...
                                 <tr role="row" class="odd" style="font-size: 14px;">
                                     <td>
                                         ...
                                         <p class="text-break"><?php echo $data["jenis_kemampuan"]; ?></p>

                                     </td>

                                     <td>

                                         <p class="text-break"><?php echo $data["prosen_sb"]; ?></p>

                                     </td>

                                     <td>

                                         <p class="text-break"><?php echo $data["prosen_b"]; ?></p>

                                     </td>
                                     <td>

                                         <p class="text-break"><?php echo $data["prosen_c"]; ?></p>

                                     </td>
                                     <td>

                                         <p class="text-break"><?php echo $data["prosen_k"]; ?></p>

                                     </td>

                                     <td>

                                         <p class="text-break"><?php echo $data["tindak_lanjut"]; ?></p>
