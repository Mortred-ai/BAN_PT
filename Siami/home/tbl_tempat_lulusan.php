     ...
     <div class="card-body">
         <div class="row">
             <div class="col-sm-10 mt-2">
                 <h2>Data Tabel Tempat Kerja Lulusan
                 </h2>
             </div>
 ...
 <?php
    ...
    $query = mysqli_query($db, "SELECT * FROM tbl_tempat_kerja_lulusan");
    ?>
                     ...
                     <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                         <thead>
                             <tr role="row ">
                                 ...
                                 <th class="text-center" colspan="3" style=" width: 63.2px;">Jumlah Lulusan Terlacak yang Bekerja Berdasarkan Tingkat/Ukuran Tempat Kerja/Berwirausaha </th>
                             ...
                             <tr>
                                 ...
                                 <th class="text-center" style="width: 63.2px;">Multinasional</th>
                             </tr>
                         </thead>
                         <tbody>
                                ...
                                ?>
                                 ...
                                 <tr role="row" class="odd" style="font-size: 14px;">
                                     ...
                                     <td>
                                         ...
                                         <p class="text-break"><?php echo $data["jml_kerja_lokal"]; ?></p>

                                     </td>
                                     <td>

                                         <p class="text-break"><?php echo $data["jml_kerja_nasional"]; ?></p>

                                     </td>

                                     <td>

                                         <p class="text-break"><?php echo $data["jml_kerja_internasional"]; ?></p>
