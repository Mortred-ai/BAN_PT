     ...
     <div class="card-body">
         <div class="row">
             <div class="col-sm-10 mt-2">
                 <h2>Data Prestasi Non Akademik Mahasiswa
                 </h2>
             </div>
 ...
 <?php
    ...
    $query = mysqli_query($db, "SELECT * FROM tbl_pres_non_akademik");
    ?>
                                ...
                                ?>
                                 ...
                                 <tr role="row" class="odd" style="font-size: 14px;">
                                     <td>
                                         ...
                                         <p class="text-break"><?php echo $data["nama_keg"]; ?></p>

                                     </td>

                                     <td>

                                         <p class="text-break"><?php echo $data["waktu_perolehan"]; ?></p>
                                     ...
                                     <td>
                                         ...
                                         <p class="text-break"><?php echo $data["pres_dicapai"]; ?></p>
