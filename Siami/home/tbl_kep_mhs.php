     ...
     <div class="card-body">
         <div class="row">
             <div class="col-sm-10 mt-2">
                 <h2>Data Tabel Kepuasan Mahasiswa
                 </h2>
             </div>
 ...
 <?php
    ...
    $query = mysqli_query($db, "SELECT * FROM  tbl_kepuasan_mhs");
    ?>
             ...
             <div class="row">
                 <div class="col-sm-12">
                     <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                         <thead>
                             <tr role="row">
                                 <th style="width: 118.2px;">Aspek yang diukur </th>
                                 <th style="width: 82.2px;">Sangat Baik </th>
                                 <th style="width: 63.2px;">Baik</th>
                                 <th style="width: 63.2px;">Cukup</th>
                                 <th style="width: 63.2px;">Kurang</th>
                                 <th style="width: 63.2px;">Rencana Tindak Lanjut oleh UPPS/PS</th>
                                ...
                                ?>
                                 ...
                                 <tr role="row" class="odd" style="font-size: 14px;">
                                     <td>
                                         ...
                                         <p class="text-break"><?php echo $data["aspek"]; ?></p>
                                     ...
                                     <td>
                                         ...
                                         <p class="text-break"><?php echo $data["tindak_lanjut_upps"]; ?></p>
