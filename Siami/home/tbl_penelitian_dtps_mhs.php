     ...
     <div class="card-body">
         <div class="row">
             <div class="col-sm-10 mt-2">
                 <h2>Data Tabel Penelitian DTPS yang Melibatkan Mahasiswa
                 </h2>
             </div>
 ...
 <?php
    ...
    $query = mysqli_query($db, "SELECT * FROM  tbl_pen_dtps_mhs");
    ?>
                     ...
                     <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                         <thead>
                             <tr role="row">
                                 ...
                                 <th style="width: 82.2px;">Tema Penelitian sesuai Roadmap </th>
                                 <th style="width: 63.2px;">Nama Mahasiswa</th>
                                 <th style="width: 63.2px;">Judul Kegiatan</th>
                                ...
                                ?>
                                 ...
                                 <tr role="row" class="odd" style="font-size: 14px;">
                                     ...
                                     <td>
                                         ...
                                         <p class="text-break"><?php echo $data["tema_pen"]; ?></p>

                                     </td>
                                     <td>

                                         <p class="text-break"><?php echo $data["nama_mhs"]; ?></p>

                                     </td>
                                     <td>

                                         <p class="text-break"><?php echo $data["judul_keg"]; ?></p>
