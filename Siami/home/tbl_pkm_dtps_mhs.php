     ...
     <div class="card-body">
         <div class="row">
             <div class="col-sm-10 mt-2">
                 <h2>Data Tabel PkM DTPS yang Melibatkan Mahasiswa
                 </h2>
             </div>
 ...
 <?php
    ...
    $query = mysqli_query($db, "SELECT * FROM tbl_pkm_dtps_mhs");
    ?>
                     ...
                     <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                         <thead>
                             <tr role="row">
                                 ...
                                 <th style="width: 82.2px;">Tema PKM sesuai Roadmap </th>
                                ...
                                ?>
                                 ...
                                 <tr role="row" class="odd" style="font-size: 14px;">
                                     ...
                                     <td>
                                         ...
                                         <p class="text-break"><?php echo $data["tema_pkm"]; ?></p>
