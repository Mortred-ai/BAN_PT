     ...
     <div class="card-body">
         <div class="row">
             <div class="col-sm-10 mt-2">
                 <h2>Data Tabel EWMP Dosen Tetap Perguruan Tinggi</h2>
             </div>
 ...
 <?php
    ...
    $query = mysqli_query($db, "SELECT * FROM  tbl_ewmp_dosen_pti");
                     ...
                     <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                         <thead>
                             <tr role="row">
                                 ...
                                 <th style="width: 63.2px;">DTPS </th>
                                 <th style="width: 82.2px;">PS yang Diakreditasi </th>
                                 <th style="width: 40.2px;">PS Lain di dalam PT </th>
                                 <th style="width: 87.2px;">PS Lain di luar PT</th>
                                 <th style="width: 63.2px;">Penelitian </th>
                                 <th style="width: 63.2px;">PkM </th>
                                 <th style="width: 63.2px;">Tugas Tambahan dan/atau Penunjang </th>
                                 <th style="width: 63.2px;">Jumlah (sks) </th>
                                 <th style="width: 63.2px;">Rata-rata per Semester (sks)</th>
