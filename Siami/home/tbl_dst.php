...
$query = mysqli_query($db, "SELECT * FROM  tbl_dosen_tetap");
                    ...
                    <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th style="width: 63.2px;">NIDN / NIDK </th>
                                <th style="width: 82.2px;">Bidang Keahlian </th>
                                <th style="width: 40.2px;">Kesesuaian dengan Kompetensi </th>
                                <th style="width: 87.2px;">Jabatan Akademik</th>
                                <th style="width: 63.2px;">Sertifikat Pendidik Profesional </th>
                                <th style="width: 63.2px;">Sertifikat Kompetensi </th>
                                <th style="width: 63.2px;">Matkul yang Diampu </th>
                                <th style="width: 63.2px;">Kesesuaian dengan Matkul </th>
                                <th style="width: 63.2px;">Matkul yang Diampu pada PS Lain</th>
