    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-10 mt-2">
                <h2>Data Tabel Pengabdian Masyarakat</h2>
            </div>
...
$query = mysqli_query($db, "SELECT * FROM  tbl_kerjasama_peng_masy");
                    ...
                    <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th style="width: 40.2px;">Manfaat bagi PS yang Diakreditasi </th>
