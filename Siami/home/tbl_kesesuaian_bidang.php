     ...
     <div class="card-body">
         <div class="row">
             <div class="col-sm-10 mt-2">
                 <h2>Data Tabel Kesesuaian Bidang Kerja
                 </h2>
             </div>
 ...
 <?php
    ...
    $query = mysqli_query($db, "SELECT * FROM tbl_kesesuaian_bidang_kerja");
    ?>
             ...
             <div class="row">
                 <div class="col-sm-12">
                     <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                         <thead>
                             <tr role="row ">
                                 <th rowspan="2" style="width: 118.2px;">Tahun Lulus </th>
                                 <th rowspan="2" style="width: 118.2px;">Jumlah Lulusan </th>
                                 <th rowspan="2" style=" width: 82.2px;">Jumlah Lulusan Terlacak </th>
                                 <th class="text-center" colspan="3" style=" width: 63.2px;">Jumlah lulusan Terlacak dengan Tingkat Keseuaian Bidang Kerja </th>
                                 <th rowspan="2" style="width: 40.2px;">Edit </th>
                                 <th rowspan="2" style="width: 40.2px;">Delete </th>
                             </tr>
                             <tr>
                                 <th class="text-center" style="width: 63.2px;">Rendah</th>
                                 <th class="text-center" style="width: 63.2px;">Sedang</th>
                                 <th class="text-center" style="width: 63.2px;">Tinggi</th>
                             </tr>
                         </thead>
                         <tbody>
                                ...
                                ?>
                                 ...
                                 <tr role="row" class="odd" style="font-size: 14px;">
                                     <td>
                                         ...
                                         <p class="text-break"><?php echo $data["tahun_lulus"]; ?></p>

                                     </td>

                                     <td>

                                         <p class="text-break"><?php echo $data["jml_lulusan"]; ?></p>

                                     </td>

                                     <td>

                                         <p class="text-break"><?php echo $data["jml_lulusan_terlacak"]; ?></p>

                                     </td>
                                     <td>

                                         <p class="text-break"><?php echo $data["jml_kesesuaian_rendah"]; ?></p>

                                     </td>
                                     <td>

                                         <p class="text-break"><?php echo $data["jml_kesesuaian_sedang"]; ?></p>

                                     </td>

                                     <td>

                                         <p class="text-break"><?php echo $data["jml_kesesuaian_tinggi"]; ?></p>
