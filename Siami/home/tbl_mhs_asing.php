    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-10 mt-2">
                <h2>Data Tabel Mahasiswa Asing</h2>
            </div>
...
$query = mysqli_query($db, "SELECT * FROM tbl_mhs_asing ");
            ...
            <div class="row">
                <div class="col-sm-12">
                    <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                        <thead>
                            <tr role="row">
                                <th style="width: 82.2px;">Program Studi </th>
                                <th style="width: 63.2px;">MHS Aktif TS-2 </th>
                                <th style="width: 63.2px;">MHS Aktif TS-1 </th>
                                <th style="width: 63.2px;">MHS Aktif TS </th>
                                <th style="width: 63.2px;">MHS Asing Full-time TS-2 </th>
                                <th style="width: 63.2px;">MHS Asing Full-time TS-1</th>
                                <th style="width: 63.2px;">MHS Asing Full-time TS </th>
                                <th style="width: 63.2px;">MHS Asing Part-time TS-2 </th>
                                <th style="width: 63.2px;">MHS Asing Part-time TS-1 </th>
                                <th style="width: 63.2px;">MHS Asing Part-time TS </th>
