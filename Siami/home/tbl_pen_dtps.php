    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-10 mt-2">
                <h2>Data Tabel Penelitian DTPS</h2>
            </div>
...
$query = mysqli_query($db, "SELECT * FROM  tbl_pen_dtps");
?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info">
                        <thead>
                            <tr role="row">
                                <th style="width: 118.2px;">Sumber Pembiayaan </th>
                                <th style="width: 82.2px;">TS-2 </th>
                                <th style="width: 40.2px;">TS-1 </th>
                                <th style="width: 87.2px;">TS</th>
                                <th style="width: 63.2px;">Jumlah </th>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr role="row" class="odd">
                                    <td>
                                        <font size="2%;">
                                            <p class="text-break"><?php echo $data["sumber_biaya"]; ?></p>
                                        </font>
                                    </td>
                                    <td>
                                        <font size="2%;">
